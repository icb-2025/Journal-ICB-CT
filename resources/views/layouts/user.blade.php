...
<body class="bg-gray-50 font-sans antialiased">
    ...
    @csrf
    <button type="submit" class="flex items-center w-full px-3 py-2 text-sm text-white bg-red-500 hover:bg-red-600 rounded-lg smooth-transition mobile-tap-target">
