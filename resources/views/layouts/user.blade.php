...
<head>
    ...
    <style>
        ...
        #sidebar {
            ...
            height: 100dvh;
            /* pakai tinggi layar real di mobile */
            width: 16rem;
            overflow: hidden;
            z-index: 40;
        ...
        @media (max-width: 767px) {
            ...
            #close-sidebar {
                ...
                box-shadow: none;
                /* hapus shadow fokus (misal Safari/Chrome mobile) */
                -webkit-tap-highlight-color: transparent;
                /* hapus highlight biru di iOS/Android */
            }
...
<body class="bg-gray-50 font-sans antialiased">
    ...
    <aside id="sidebar" class="text-gray-800 shadow-lg smooth-transition -translate-x-full md:translate-x-0">
        <div class="flex flex-col h-full">
            ...
            <!-- Sidebar -->
            <aside id="sidebar"
                class="bg-white text-gray-800 shadow-lg smooth-transition -translate-x-full md:translate-x-0">
                <div class="flex flex-col h-full">
                    <!-- Logo & Toggle -->
                    <div class="flex items-center justify-between p-4 border-b">
                        <a href="/" class="flex items-center space-x-2">
                    ...
                    <nav class="flex-1 overflow-y-auto py-4">
                        <ul class="space-y-1 px-2">
                            <li>
                                <a href="{{ route('index') }}"
                                    class="flex items-center p-4 hover:bg-gray-100 rounded-lg">
                        ...
                        @auth
                            ...
                            <div class="mt-3 space-y-1">
                                <a href="{{ route('profile.edit') }}"
                                    class="flex items-center w-full px-3 py-3 hover:bg-gray-200 rounded-lg">
                                ...
                                <form method="POST" action="{{ route('logout') }}">
                                    @csrf
                                    <button type="submit"
                                        class="flex items-center w-full px-3 py-3 bg-red-500 text-white rounded-lg">
